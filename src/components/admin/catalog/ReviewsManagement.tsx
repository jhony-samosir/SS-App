      ...
      render: (rev: ProductReview) => (
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col min-w-0">
            <span className="font-bold text-sm truncate-max" title={rev.UserName}>{rev.UserName}</span>
            <span className="text-[10px] text-dimmed uppercase tracking-wider">User ID: {rev.UserID.slice(0, 8)}...</span>
          </div>
        </div>
      ),
    },
